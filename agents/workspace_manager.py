# Script name : workspace_manager.py
# location : agents\workspace_manager.py
# accessible from Libraries = yes
# Author: KHM Smartbuild
# Created: 24/05/2023
# Updated: 24/05/2023
# Copyright: (c) 2023 KHM Smartbuild
# Purpose: This script is used to manage the workspace for the Sparky Buddy project. It includes functions for handling file paths within the workspace.
...
WORKSPACE_PATH = Path(os.getcwd()) / "sparky_buddy_workspace"
